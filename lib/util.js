...
util.findAngle = function(bulletVec, shipVec, magnitude) {
  var turnX = bulletVec[0] * 30 - shipVec[0] * magnitude;
  var turnY = bulletVec[1] * 30 - shipVec[1] * magnitude;
  return Math.atan2(turnY, turnX)+ Math.PI/2;
}
